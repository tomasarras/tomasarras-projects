...
const Badge = ({ children }) => (<span className={`${styles.badgeText} bg-accent-secondary text-xs font-medium me-2 px-2.5 py-0.5 rounded-full`}>{children}</span>);
  ...
  return (
    <div>
      <ol className={`md:grid md:grid-cols-2 ${styles.ol}`}>  
        <Item i={0} total={4} time={t("certisur.time")} title={<>{t("certisur.title")}<a href={t("certisur.link")} className='text-blue-600 dark:text-blue-500 hover:underline hover'>CertiSur</a></>} first>
          <p className='text-gray-500 dark:text-gray-400 mb-3'>{t("certisur.description")}</p>
          <Badge>Spring</Badge>
          <Badge>Vue</Badge>
        </Item>
        <Item i={1} total={4} time={t("taggify.time")} title={<>{t("taggify.title")}<a href={t("taggify.link")} className='text-blue-600 dark:text-blue-500 hover:underline hover'>Taggify</a></>}>
        ...
        <Item i={2} total={4} time={t("ideaas.time")} title={<>{t("ideaas.title")}<a href="https://www.ideaas.com.ar/" className='text-blue-600 dark:text-blue-500 hover:underline hover'>IDEAAS</a></>}>
          <p className='text-gray-500 dark:text-gray-400 mb-3'>
        ...
        <Item i={3} total={4} time={t("unicen.time")} title={<>{t("unicen.title")}<a href={t("unicen.link")} className='text-blue-600 dark:text-blue-500 hover:underline hover'>UNICEN</a> {t("unicen.title2")}</>} last>
